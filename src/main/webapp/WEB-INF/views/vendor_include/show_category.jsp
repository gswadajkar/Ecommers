					...
					<tbody>
						<c:forEach var="cat" items="${categoryList}">
							<tr>
								...
								<td><a href='<spring:url value="/vendor/product_list?id=${cat.id}"/>'>Show all products</a></td>
								<td><a href='<spring:url value="/vendor/product_add?id=${cat.id}"/>'>Add a new Product</a></td>
						   </tr>
						</c:forEach>
					</tbody>
				</table>
