...
<body >
<%
Customer customerDetails=(Customer)session.getAttribute("customerDetails");

if ((customerDetails.getCart().getCartItems() == null)) {
%> <script>alert("Your Cart is Empty");
...
<%@include file="../customer_include/view_cart.jsp" %>
