...
<link rel="stylesheet" href="<spring:url value='/css/admin_style.css'/>"
	type="text/css" />
	<link rel="stylesheet" href="<spring:url value='/css/vendor_registration.css'/>"
	type="text/css" />
...
<body class="fixed-nav sticky-footer bg-dark" id="page-top">
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" id="mainNav">
    <a class="navbar-brand" href="<spring:url value='/admin/admin_dashboard'/>">More To Store</a>
      ...
      <ul class="navbar-nav navbar-sidenav" id="exampleAccordion">
        ...
        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="layout">
          <a class="nav-link nav-link-collapse collapsed" data-toggle="collapse" href="#layout" data-parent="#exampleAccordion">
            ...
            <li>  
              <a href="<spring:url value='/admin/category'/>"> <i class="fa fa-fw fa-link"></i> Category</a>
            </li>
            <li>
              <a href="<spring:url value='/admin/subcategory'/>"><i class="fa fa-fw fa-link"></i>Sub Category</a>
            </li>
              <li>  
              <a href="<spring:url value='/admin/banner'/>"> <i class="fa fa-fw fa-link"></i> Banner</a>
            </li>
            <li>
              <a href="<spring:url value='/admin/advertisement'/>"><i class="fa fa-fw fa-link"></i>Advertisement</a>
            </li>
          </ul>
        </li>
         <li class="nav-item" data-toggle="tooltip" data-placement="right" title="vendor">
          <a class="nav-link nav-link-collapse collapsed" data-toggle="collapse" href="#vendor" data-parent="#exampleAccordion">
            ...
            <li>  
              <a href="<spring:url value='/admin/vendor_details'/>">  <i class="fa fa-fw fa-file"></i> Vendor Details</a>
            </li>
            <li>
              <a href="<spring:url value='/admin/vendor_registration'/>"><i class="fa fa-fw fa-file"></i>Vendor Registration</a>
            </li>
