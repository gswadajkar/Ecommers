...
<body>
	...
	<div class="container-fluid">
							...
							<div class="row">
								<div class="col-md-6 card-button">
									<a
										...
										<div class="card-button-inner bag-button">AddtoCart</div>
									</a>
								</div>
								<div class="col-md-6 card-button">
									<a
		...
		<hr>
			<div class="row">
			<c:forEach items="${omobileList}" var="mobile">
				<div class="col-md-3">
					<div class="dress-card">
						<div class="dress-card-head">
					...
					<div class="col-md-3">
						<div class="dress-card">
							<div class="dress-card-head">
								...
								<img class="dress-card-img-top product-image"
									src="data:image/jpeg;base64,${fashion.imgUtility}" alt="sai">
								<div class="surprise-bubble">
									<span class="dress-card-heart"> <i class="fas fa-heart"></i>
									</span><a
										href='<spring:url value="/customer/fashion_details?pid=${fashion.id}"/>'>
										<span>More Details</span>
									</a>
								</div>
							</div>
							<div class="dress-card-body">
								...
								<p class="dress-card-para">
									<span class="dress-card-price">${fashion.price}
								</p>
								<div class="row">
									<div class="col-md-6 card-button">
										<a
									...
									<div class="col-md-6 card-button">
										<a
											href='<spring:url value="/customer/addtowish?pid=${fashion.id}"/>'>
											<div class="card-button-inner wish-button">Whishlist</div>
										</a>
									</div>
								</div>
		...
		<div class="row">
			<c:forEach items="${advList}" var="adv">
				<div class="col-md-3 text-center">
					<div class="dress-card">
						<div class="dress-card-head">
<a href="<spring:url value='show_Mobiles?subCId=${adv.cTitle}'/>">
							<img  style="height: 150px; width: 150px" class="dress-card-img-top product-image"
								src="data:image/jpeg;base64,${adv.imgUtility}" alt="sai">
							</a>
						</div>
